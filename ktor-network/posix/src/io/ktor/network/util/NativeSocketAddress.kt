...
internal class NativeIPv6SocketAddress(
    ...
    override fun nativeAddress(block: (address: CPointer<sockaddr>, size: socklen_t) -> Unit) {
        cValue<sockaddr_in6> {
            interop_sin6_family = family
            interop_sin6_flowinfo = flowInfo
            interop_sin6_port = hostToNetworkOrder(port.toUShort())
            interop_sin6_scope_id = scopeId
